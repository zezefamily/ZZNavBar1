...
- (void)createTableView
{
    ...
    self.leftTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, _frame.size.width/2, 300) style:UITableViewStylePlain];
    self.leftTableView.delegate = self;
    self.leftTableView.dataSource = self;
    self.leftTableView.tableFooterView = [[UIView alloc]init];
    [self addSubview:self.leftTableView];
    
    self.rightTableView = [[UITableView alloc]initWithFrame:CGRectMake(_frame.size.width/2, 0, _frame.size.width/2, 300) style:UITableViewStylePlain];
